...
def get_args():
    ...
    if not 0 < args.eucdistper < 1:
        parser.error(f'--eucdistper ({args.eucdistper}) must be b/w 0 and 1')

    if args.sampledist < 0:
        parser.error('--sampledist ({args.sampledist}) must be > 0')
